...
const Receitas: React.FC = () => {
  ...
  const handleSubmit = () => {
    ...
    const payload = { type: 'income' as const, amount, description: form.description, category: form.category, date: form.date, status: 'paid' as const, account_type: 'personal' as const };
    ...
    <PageTransition>
      <div className="space-y-4 md:space-y-6">
        ...
        <TransactionGroupedList
          transactions={filtered} type="income"
