    ...
    >
      ...
      <div className="absolute inset-[3px] rounded-[41px] overflow-hidden bg-[hsl(210,8%,7%)] flex flex-col">
        ...
        <div className="flex-1 p-2.5 space-y-1.5 overflow-hidden bg-[hsl(210,5%,8%)]" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M30 5 L35 15 L30 25 L25 15Z\' fill=\'%23ffffff08\'/%3E%3C/svg%3E")' }}>
          ...
          <UserBubble time="10:33">
            {t("mockup.userMsg2")}
          </UserBubble>
          <BotBubble time="10:33">
            {t("mockup.botMsg2")}
          </BotBubble>
        </div>
  ...
  >
    ...
    >
      ...
      <div className="absolute inset-[3px] rounded-[45px] overflow-hidden bg-[hsl(210,8%,7%)] flex flex-col">
        ...
        {/* Chat area */}
        <div className="flex-1 p-3 space-y-2 overflow-hidden bg-[hsl(210,5%,8%)]" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M30 5 L35 15 L30 25 L25 15Z\' fill=\'%23ffffff08\'/%3E%3C/svg%3E")' }}>
          <UserBubble time="10:32">
            🎤 {t("mockup.userMsg1")}
          </UserBubble>
          <BotBubble time="10:32">
      ...
      <section className="py-14 sm:py-28 px-4 sm:px-6 relative">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mt-8 sm:mt-14 items-stretch">
              ...
              <ul className="space-y-2.5 sm:space-y-3 mb-6 sm:mb-8 flex-1">
                {[t("landing.pricing.free1"), t("landing.pricing.free2"), t("landing.pricing.free3")].map(f => (
                  <li key={f} className="flex items-center gap-2 text-xs sm:text-sm text-zinc-400">
                    <Check className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-zinc-500 shrink-0" />{f}
                  </li>
                ))}
              </ul>
              <Link to={signupLink}>
            ...
            {/* ── Copiloto Premium ── */}
            <motion.div {...fadeUp(0.2)} className="relative h-full rounded-xl sm:rounded-2xl border border-[hsl(348,80%,55%)/0.3] bg-zinc-900 md:scale-105 origin-center overflow-visible shadow-[0_0_30px_rgba(239,68,68,0.1)] flex flex-col">
              {/* Badge pill */}
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-20 bg-zinc-950 border border-[hsl(348,100%,64%)/0.5] text-[hsl(348,100%,64%)] text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
