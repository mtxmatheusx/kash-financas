  ...
  <nav className="fixed top-0 inset-x-0 z-50 backdrop-blur-2xl bg-[hsl(var(--landing-bg)/0.85)] border-b border-[hsl(var(--landing-border)/0.4)]" aria-label="Main navigation">
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2 sm:gap-3 relative z-10">
        ...
        <Link to={signupLink}>
          <Button size="sm" className="bg-[hsl(var(--landing-cta))] hover:bg-[hsl(var(--landing-cta)/0.85)] text-white cta-glow border-0 font-semibold text-xs sm:text-sm px-3 sm:px-4">
